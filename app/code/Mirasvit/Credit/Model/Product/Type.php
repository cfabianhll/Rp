...
class Type extends \Magento\Catalog\Model\Product\Type\Virtual
{
    ...
    /**
     * @var \Mirasvit\Credit\Model\ResourceModel\ProductOptionCredit\CollectionFactory
     */
    private $productOptionCreditCollection;
    /**
     ...
     * @param \Mirasvit\Credit\Model\ResourceModel\ProductOptionCredit\CollectionFactory $productOptionCreditCollection
    ...
    public function getOrderOptions($product)
    {
        ...
        $productOption->setId('creditOption')
            ->setType(\Magento\Catalog\Model\Product\Option::OPTION_TYPE_FIELD);
        ...
        $productOption2 = clone $productOption;
        $productOption2->setId('creditOptionId');
        $productOptions[] = $productOption2;
