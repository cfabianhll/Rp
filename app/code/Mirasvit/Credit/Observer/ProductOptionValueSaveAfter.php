...
{
    /**
     * @var \Mirasvit\Credit\Model\ResourceModel\ProductOptionCredit
     */
    private $productOptionCreditResource;
    /**
    ...
    /**
     * ProductOptionValueSaveAfter constructor.
     * @param \Mirasvit\Credit\Model\ProductOptionCreditFactory $productOptionCreditFactory
     * @param \Mirasvit\Credit\Model\ResourceModel\ProductOptionCredit $productOptionCreditResource
     */
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        foreach ($options as $option) {
            ...
            $creditOption
                ...
                ->setTitle(__('credit option'))
                ->setPrice($option[Composite::FIELD_PRICE_NAME])
                ->setPriceType('fixed')
                ->setType('field')
            ;
