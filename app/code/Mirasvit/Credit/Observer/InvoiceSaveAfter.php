...
class InvoiceSaveAfter extends \Mirasvit\Credit\Observer\AbstractObserver
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        // is new invoice
        if ($invoice->getOrigData() === null && $invoice->getBaseCreditAmount() && !$invoice->getCreditCalculated()) {
            ...
            // some 3rd party extensions call save event several times
            $invoice->setCreditCalculated(true);
        }
