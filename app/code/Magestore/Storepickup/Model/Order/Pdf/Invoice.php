...
use Magestore\Storepickup\Helper\Data as HelperData;
...
class Invoice extends \Magento\Sales\Model\Order\Pdf\Invoice
{
    ...
    public function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $this->_storepickupHelper = $objectManager->get(HelperData::class);
        $this->driver = $objectManager->get(DriverInterface::class);
