...
define(
    ...
    function ($, resourceUrlManager) {
        ...
        return $.extend({
            ...
            getOscUrlForEstimationShippingMethodsByAddressId: function (quote) {
                var params = this.getCheckoutMethod() == 'guest' ? //eslint-disable-line eqeqeq
                    {
                        quoteId: quote.getQuoteId()
                    } : {},
                    urls = {
                        'default': '/carts/mine/osc-estimate-shipping-methods-by-address-id'
                    };

                return this.getUrl(urls, params);
            },
            getOscUrlForEstimationShippingMethodsForNewAddress: function (quote) {
                var params = this.getCheckoutMethod() == 'guest' ? //eslint-disable-line eqeqeq
                    {
                        quoteId: quote.getQuoteId()
                    } : {},
                    urls = {
                        'guest': '/guest-carts/:quoteId/osc-estimate-shipping-methods',
                        'customer': '/carts/mine/osc-estimate-shipping-methods'
                    };
