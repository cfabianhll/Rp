    ...
    config = {
        map: {
            '*': {
                ...
                'Magento_Checkout/js/model/shipping-rate-processor/customer-address': 'Mageplaza_Osc/js/model/shipping-rate-processor/customer-address-mixin',
                'Magento_Checkout/js/model/shipping-rate-processor/new-address': 'Mageplaza_Osc/js/model/shipping-rate-processor/new-address-mixin'
            },
        ...
        config: {
            mixins: {
                ...
                'Mageplaza_Osc/js/action/details-mixin': true
            }
